    ...
    return (
        <div>
            ...
            onSubmit={handleSubmit(onFormSubmit)}>
                ...
                <input type="text" id="username" className="border w-full p-3" {...register("username", { required: "username is required", minLength: 5, maxLength: 15,validate: (value) => value.includes("a") })} />
